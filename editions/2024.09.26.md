...
"[E]ngineering preview of the work that is going into Automerge 3.0. Big memory use improvements, load & save performance, scaled-out sync, and biggest of all: an integrated E2EE and auth system."
