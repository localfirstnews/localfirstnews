...
Andrey Sitnik (**@sitnikcode**) recaps the main idea of every talk from Local‑First Conf in Berlin.

### [Local-First (LoFi) Meetup #18](https://www.youtube.com/watch?v=F6a78MtPUSw&list=PLTbD2QA-VMnXFsLbuPGz1H-Najv9MD2-H&index=22)
...
Discussed the frustrations with modern software, particularly how the shift from desktop to cloud-based platforms has led to losses in privacy, control, and user autonomy. and advocates for local-first software, self-hosting, and decentralized systems. See also [HN discussion](https://news.ycombinator.com/item?id=41300888).
...
### [When does local-first make sense?](https://www.youtube.com/watch?v=vLRtC53rwCg)
...
### [DWeb Deep Dive: Authoring Decentralized App Protocols](https://www.youtube.com/watch?v=Wh5Cndgcc_E)
...
Post by **@cahofmeyr** comparing ElectricSQL's new 'electric-next' to PowerSync — both sync engines designed to work with existing Postgres databases.
...
### [CopyCat Clipboard](https://www.entilitystudio.com/copycat-clipboard)
"CopyCat Clipboard only [temporarily] stores your text clipboard item on server for syncing across device and permanently store them locally on your device."
